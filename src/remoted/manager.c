        ...
        *post_startup = false;
        ...
        if (is_startup) {
            ...
            *post_startup = true;
            ...
            /* Check and report offline gap before marking agent active.  */
            ...
            /* Record disconnect timestamp for offline gap tracking.       */
            agent_offline_record_disconnect(key->id, time(NULL));
